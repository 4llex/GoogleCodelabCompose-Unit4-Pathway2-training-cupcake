...
// @Test1    Verify the Start screen content.
// @Test2    Implemented at codelab - verify order screen content
// @Test3    Verify the Summary screen content.
// @Test4    Verify that the Next button is enabled when an option is selected on the Choose Flavor screen.
